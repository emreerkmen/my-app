...
let ResumeComponent = class ResumeComponent {
    constructor(activatedRoute, resumeService) {
        this.activatedRoute = activatedRoute;
    ...
    getTitles$(titleId) {
        if (titleId) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(title => console.log("A title fetched:")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
        else {
            return this.http.get(this.apiUrl + "titles").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(title => console.log("Titles fetched.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
    }
    createTitle$(title) {
        if (title) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(title => console.log(title.title + " isimli title kaydedildi.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
    }
    updateTitle$(title) {
        if (title) {
            return this.http.put(this.apiUrl + "titles/", title).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(title => console.log(title.title + " isimli title güncellendi.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
    }
    deleteTitle$(title) {
        if (title) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(title => console.log(title.title + " isimli title silindi.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
    }
    ...
    getCompanies$(companyId) {
        if (companyId) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(c => console.log("A Company fetched:")));
        }
        else {
            return this.http.get(this.apiUrl + "companies").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(c => console.log("Componies fetched.")));
        }
    }
    getDescs$(descId) {
        if (descId) {
            return this.http
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(c => console.log("A Description fetched:")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
        else {
            return this.http.get(this.apiUrl + "descs").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(c => console.log("Descriptions fetched.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
        }
    }
    getResumeDetail$() {
        return this.http.get(this.apiUrl + "resumes/getdetail").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(result => result.sort((obj1, obj2) => {
            if (obj1.startDate < obj2.startDate) {
                return 1;
            }
            if (obj1.startDate > obj2.startDate) {
            ...
            return 0;
        })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(c => console.log("Resume detail fetched.")), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.errorHandler));
    }
    errorHandler(error) {
        let errorMessage = "";
